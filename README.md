...
#### 🟩초록색 
  ...
  - 웹소설을 보는데 웹소설이 보통 돈을 주고 결제하는 시스템이다 보니 리뷰를 볼 수 있는 플랫폼이 있으면 어떠한가?
...
#### 🟥빨간색
 ...
 - 그렇다면 리뷰를 쓰게 한다면 보상을 지급하는 부분의 필요하지 않은가?
 - 넷플릭스 경우 다양하게 장르별로 사용자에게 추천하는데 만약 구현한다면 해당 부분이 있으면 좋지 않은가?
 - 왓챠의 경우, 자주 보는 드라마가 있다면 새 화가 올라 올 때마다 문자 알림이 오는데 해당 부분도 있으면 좋지 않은가?
 
#### ⬛검정색
 - 만약 영수증으로만 리뷰를 작성한다면 오프라인으로 대여한 사람은 리뷰를 어떻게 작성하는가?
 - 자신에게 아무것도 주어지지 않는데 굳이 전자 영수증을 등록하면서까지 리뷰를 작성하는가?
 - 그렇다면 그에 따른 상이 있으면 좋지 않은가?
 ...
 #### 🟦파란색
  ...
  - 그러나 구매이력을 통한 인증 시스템은 실제로 구매하지 않더라도 리뷰를 쓸 수 있는 방안에 대해 생각해 볼 필요성 있음
...
#### ⬛검정색
 ...
 - 다른 유사사이트와 별 차이점이 없어 보이는데 사용자들이 과연 해당 사이트를 많이 이용할 것인가?
